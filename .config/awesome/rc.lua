...
epochclock = wibox.widget.textbox()
epochclock:set_text("")

mytimer = timer({ timeout = 1 })
mytimer:connect_signal("timeout", function() epochclock:set_text(os.time()) end)
mytimer:start()
...
--    awful.key({ modkey,           }, "Left",   awful.client.focus.bydirection("left")),
--    awful.key({ modkey,           }, "Right",   awful.client.focus.bydirection("right")),
...
-----------------------------------------------------------------
    ...
    awful.key({ modkey, "Shift"}, "Left", function () awful.screen.focus_bydirection("left") end),
    awful.key({ modkey, "Shift"}, "Right", function () awful.screen.focus_bydirection("right") end),
...
client.connect_signal("focus", function(c) c.border_color = "#006699" end)
